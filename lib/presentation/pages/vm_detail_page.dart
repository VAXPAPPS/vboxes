...
class _HeaderCard extends StatelessWidget {
  ...
  Color get _statusColor {
    switch (state.vm.status) {
      case _ when state.vm.status.isRunning:
        return const Color(0xFF34C759);
      case _ when state.vm.status.isPaused:
                ...
                if (state.vm.status.canStart)
                  _QuickAction(
                    ...
                    onTap: () async {
                      ...
                      if (context.mounted) {
                        context.read<VmDetailBloc>().add(
                          LoadVmDetail(state.vm.name),
                        );
      ...
      child: Padding(
        ...
        child: Wrap(
          ...
          children: [
            ...
            _InfoItem(label: 'Operating System', value: vm.osType),
            _InfoItem(label: 'vCPU', value: '${vm.vcpus} cores'),
            _InfoItem(
              label: 'Memory',
              value: '${vm.ramMb} MB (${vm.ramGb} GB)',
            ),
          ],
        ),
      ),
